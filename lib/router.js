...
router.get('/dailyfx/all', require('./routes/dailyfx/all'));
//中国银行外汇
router.get('/boc/zgyhwh', require('./routes/boc/zgyhwh'));
router.get('/boc/zgyhhj', require('./routes/boc/zgyhhj'));
...
// wechat
router.get('/wechat/gitrss/:bizid', require('./routes/tencent/wechat/gitrss'));
